...
while IFS='' read -r line || [[ -n "$line" ]]; do
    cb_servers+="http://$line:8091/pools"
...
perl -pe "s/%PLACEHOLDER_API_IDM_HOST%/$idm_url/g" | \
perl -pe "s/%PLACEHOLDER_API_ES_CLUSTER_NAME%/$ES_CLUSTER_NAME/g" > ./servioticy-api-private/src/main/resources/config.properties
