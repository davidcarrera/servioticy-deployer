...
echo "$MYSQL_MD5 $MYSQL_FILE" > $FILE_REPOSITORY/$SECURITY_FILE_MD5
...
if [ $count -gt 0 ]
then
 	echo Corrupt or missing file found. Downloading $MYSQL_FILE_WGET
	wget -q $MYSQL_FILE_WGET -O $FILE_REPOSITORY/$MYSQL_FILE
else
