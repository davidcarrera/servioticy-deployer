...
dsh -f $MACHINE_FILES_FOLDER/$MACHINE_FILE_IDM  "cd $ROOT; $SCRIPTS_FOLDER/stop_uaa.sh"
dsh -f $MACHINE_FILES_FOLDER/$MACHINE_FILE_IDM  "cd $ROOT; $SCRIPTS_FOLDER/stop_mysql.sh"
dsh -f $MACHINE_FILES_FOLDER/$MACHINE_FILE_SECURITY  "cd $ROOT; $SCRIPTS_FOLDER/stop_security.sh"
dsh -m $dispatcher_master  "cd $ROOT; $SCRIPTS_FOLDER/stop_dispatcher.sh"
